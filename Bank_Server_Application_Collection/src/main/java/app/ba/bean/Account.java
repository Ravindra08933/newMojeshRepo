...
public class Account {
    ...
    private HashMap<Integer,List<Transaction>> transactions;
    ...
    public HashMap<Integer, List<Transaction>> getTransactions() {
        return transactions;
    }
    public void setTransactions(HashMap<Integer, List<Transaction>> transactions) {
