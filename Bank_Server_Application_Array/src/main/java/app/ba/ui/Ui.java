                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    switch (update)
                                                                    {
                                                                        case 1:
                                                                            ...
                                                                            try
                                                                            {
                                                                                System.out.println(accountService.updateAccount(accNum, name));
                                                                            }
                                                                            catch (AccountNotFoundException message)
                                                                            {
                                                                                System.out.println(message);
                                                                        ...
                                                                        case 2:
                                                                            ...
                                                                            try
                                                                            {
                                                                                System.out.println(accountService.updateAccountEmail(accNum, email));
                                                                            }
                                                                            catch (AccountNotFoundException message)
                                                                            {
                                                                                System.out.println(message);
                                                    ...
                                                    else
                                                    {
                                                        switch (transactionChoice)
                                                        {
                                                            case 1:
                                                                ...
                                                                try
                                                                {
                                                                    Transaction[] transactions = transactionService.getLast10Transactions(accNum);
                                                            ...
                                                            case 2:
                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    try
                                                                    {
                                                                        Transaction[] transactions = transactionService.getAllTransactions(accNum);
                                                                        for (Transaction transaction : transactions)
                                                                        {
                                                                            if (transaction != null)
                                                                                System.out.println(transaction);
                                                            ...
                                                            case 3:
                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    try
                                                                    {
                                                                        Transaction[] transactions = transactionService.getTransactionByType(accNum, type);
                                                            ...
                                                            case 5:
                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    try
                                                                    {
                                                                        Transaction[] transactions = transactionService.getPreviousDaysTransactions(accNum, days);
                                                                        for (Transaction transaction : transactions)
                                                                        {
                                                                            if (transaction != null)
                                                                                System.out.println(transaction);
