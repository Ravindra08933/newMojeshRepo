...
public class Bank_Server_Application_Spring {

    public void Main(AccountService accountService, CustomerService customerService, TransactionService transactionService) {
                                                    ...
                                                    if (choice == 0) {
                                                        ...
                                                        switch (choice) {
                                                            ...
                                                            case 6:
                                                                int ch;
                                                                double money;
                                                                System.out.println("1. Create Account for New Customer");
                                                                System.out.println("2. Create Account for Existing Customer Customer");
                                                                ch = scanner.nextInt();
                                                                if (ch == 1) {
                                                                    ...
                                                                    System.out.println(accountService.createAccount(customer, money, "Savings"));
                                                                }
                                                                if (ch == 2) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        System.out.println(accountService.createAccount(customer, money, "Current"));
                                                    ...
                                                    if (customerChoice == 0) {
                                                        ...
                                                        switch (customerChoice) {
                                                            ...
                                                            case 6:
                                                                ...
                                                                email = scanner.next();
                                                                System.out.println(customerService.createCustomer(name, email));
                                                                break;
                                                            default:
                                                                System.out.println("Invalid Choice");
                                                                break;
