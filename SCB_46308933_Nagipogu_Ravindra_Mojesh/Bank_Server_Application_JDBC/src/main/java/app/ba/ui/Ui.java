                                                        ...
                                                        switch (choice)
                                                        {
                                                            ...
                                                            case 2:
                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    catch (AccountNotFoundException | SQLException message )
                                                                    {
                                                                        System.out.println(message);
                                                                    }
                                                                }
                                                            ...
                                                            case 6:
                                                                ...
                                                                if(ch==2)
                                                                {
                                                                    ...
                                                                    try {
                                                                        System.out.println(accountService.createAccount1(id,money));
                                                                    } catch (SQLException message) {
                                                                        System.out.println(message.getMessage());
                                                                    }
                                                                }
                                                    ...
                                                    else
                                                    {
                                                        switch (customerChoice)
                                                        {
                                                            case 1:
                                                                ...
                                                                catch (CustomerNotFoundException | SQLException message)
                                                                {
                                                                    System.out.println(message.getMessage());
                                                                }
                                                                break;
                                                    ...
                                                    else
                                                    {
                                                        switch (transactionChoice)
                                                        {
                                                            case 1:
                                                                ...
                                                                catch (TransactionNotFoundException | SQLException message)
                                                                {
                                                                    System.out.println(message.getMessage());
                                                                }
                                                                break;
